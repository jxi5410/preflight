"""LLM abstraction layer for Preflight.
...
TIER_PRESETS: dict[str, tuple[str, TierModels]] = {
    ...
    "premium": (
        ...
        TierModels(
            ...
            smart="claude-opus-4-6-20250514",
        ),
    ),
    "openai": (
        "openai",
...
class LLMClient:
    ...
    def complete(
        ...
        if self.provider == "anthropic":
            msg = self._client.messages.create(
                ...
                system=system or "You are Preflight, an AI QA evaluation system.",
            ...
            config = types.GenerateContentConfig(
                system_instruction=system or "You are Preflight, an AI QA evaluation system.",
    ...
    def complete_json(
        ...
        full_system = (system or "You are Preflight, an AI QA evaluation system.") + (
